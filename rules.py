...
ANOMALY_RULES = {
    ...
    "bronze_order_items": {
        ...
        # Check: load_trend_shift.py (5x increase)
        ...
        # NEW RULE: Health Check / Heartbeat for load_normal_data.py
        # If rows are within normal range (10-200), log an INFO message.
    ...
    "bronze_order_payments": {
        ...
        # Check: load_deletion.py (Accidental Data Loss)
        "row_count_deletion": {
