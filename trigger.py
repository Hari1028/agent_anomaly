...
from etl.load_normal_data import run_normal_injection # <--- NEW: Control Group
...
def main():
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "deletion", "trend_shift", "normal", "all"
        ], 
    ...
    if args.scenario == "spike":
        ...
        run_deletion_injection()
        run_trend_shift_injection()
        run_normal_injection() # <--- NEW: Add to 'all' suite
